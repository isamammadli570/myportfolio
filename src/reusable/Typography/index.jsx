...
function Typography({ type, style, content }) {
  const styles = {
    ...
    side_nav:
      "hover:border-b-2  dark:hover:border-stone-200  dark:text-stone-200 uppercase tracking-widest cursor-pointer font-medium transition-all duration-200 text-xl md:text-2xl  border-stone-800 hover:skew-x-3 hover:skew-y-1",
  };
