      ...
      <FlexUi type="center" style="my-0 flex-col md:flex-row  mx-10 gap-20">
        ...
        <FlexUi type="none" style="flex-col text-center">
          <FlexUi type="center" style="flex-col md:flex-row gap-5">
            <div className="border-[1px] border-stone-700 w-[450px] py-10 rounded-3xl">
              <FlexUi
                type="none"
          ...
          <p className="md:w-[50rem] mt-5">
            ...
            ratione! Minus error quidem nesciunt rerum maiores corrupti itaque,
            mollitia hic quibusdam maxime similique veritatis delectus
